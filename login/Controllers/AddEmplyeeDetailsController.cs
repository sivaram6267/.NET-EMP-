...
namespace login.Controllers
{
    public class AddEmplyeeDetailsController : Controller
    {
        ...
        public ActionResult Create(int id, AddEmployeeDetails addEmployeeDetails)
        {
            addEmployeeDetails = db.Employee_details.Join(db.Client_Details,
               x => x.Emp_Id,
               y => y.Emp_id_fk,
        ...
        public ActionResult Create(AddEmployeeDetails addEmployeeDetails)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                obj1.Emp_id_fk = addEmployeeDetails.Emp_Id;
                db.Client_Details.Add(obj1);
                db.SaveChanges();
                Bill obj2 = new Bill();
                obj2.Emp_Id_FK = addEmployeeDetails.Emp_Id;
        ...
        public ActionResult Edit(int id, AddEmployeeDetails addEmployeeDetails)
        {
